...
import image1 from "@assets/moodscape.webp";
import image2 from "@assets/Poster.webp";
import image3 from "@assets/Mockup-poster.webp";

<ProjectImage path={image1} alt="Music Advertising Poster"/>
<ProjectImage path={image2} alt="Music Advertising Poster"/>
<ProjectImage path={image3} alt="Music Advertising Poster"/>
